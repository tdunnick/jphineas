 ...
 */
 ...
 /*
  * calling application only needs to XTrustProvider.install();
  */
...
{
  private static final long serialVersionUID = -6546219589735412278L;
	...
	public XTrustProvider()
	{
		...
		AccessController.doPrivileged(new PrivilegedAction()
		{
			...
			{
				put(
					"TrustManagerFactory." + TrustManagerFactoryImpl.getAlgorithm(),
	...
	public static void install()
	{
		...
		{
			Security.insertProviderAt(new XTrustProvider(), 1);
